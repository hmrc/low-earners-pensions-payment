...
| <div style="width:200px">Scenario</div> | <div style="width:300px">Description</div>                                                                                                              | <div style="width:75px">Identifier</div>                    | <div style="width:50px">Status</div> | <div style="width:100px">Example</div>                                          |
|-----------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|--------------------------------------|---------------------------------------------------------------------------------|
| Default success                         | A success response with `200` status code where<br/>the user has a mixture of all four supported claim<br/>status values across 4 tax years (2022-2025) | `AA1******`<br/>`ER2******`                                 | `200`                                | [Default success](./resources/EXAMPLES.MD#default-success-summary-scenario)     |
| 'None available' success                | A success response with `200` status code where<br/>the user has no available payments                                                                  | `AA2******`<br/>`AA3******`<br/>`AA4******`<br/>`AA5******` | `200`                                | [None available](./resources/EXAMPLES.MD#none-available-summary-scenario)       |
| 'Not eligible' success                  | A success response with `200` status code where<br/>the user has no applicable data                                                                     | `AA6******`<br/>`ER1403***`<br/>`ER1404***`                 | `200`                                | [Not eligible](./resources/EXAMPLES.MD#not-eligible-summary-scenario)           |
| 'Suspended' success                     | A success response with `200` status code where<br/>the user has only suspended items                                                                   | `AA7******`                                                 | `200`                                | [Suspended](./resources/EXAMPLES.MD#suspended-summary-scenario)                 |
| 'Underpayment' success                  | A success response with `200` status code where<br/>the user has available and historic 'underpayment' data                                             | `AA8******`                                                 | `200`                                | [Underpayment](./resources/EXAMPLES.MD#underpayment-summary-scenario)           |
| 'Multiple payments' success             | A success response with `200` status code where<br/>the user has multiple available payments                                                            | `AA9******`                                                 | `200`                                | [Multiple payments](./resources/EXAMPLES.MD#multiple-payments-summary-scenario) |
...
| <div style="width:200px">Scenario</div> | <div style="width:300px">Description</div>                                                                                                            | <div style="width:75px">Identifier</div>    | <div style="width:50px">Status</div> | <div style="width:100px">Example</div>                                                           |
|-----------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|--------------------------------------|--------------------------------------------------------------------------------------------------|
| Default success                         | Success response with `200` status code where<br/>the user has a mixture of all four supported claim<br/>status values across 4 tax years (2022-2025) | `AA1******`<br/>`ER2******`                 | `200`                                | [Default success](./resources/EXAMPLES.MD#default-success-details-scenario)                      |
...
| 'Suspended' success                     | Success response with `200` status code where<br/>the user has only 'suspended' payment data                                                          | `AA7******`                                 | `200`                                | [Suspended](./resources/EXAMPLES.MD#suspended-details-scenario)                                  |
| 'Undepayment' success                   | Success response with `200` status code where<br/>the user has available and historic 'underpayment' data                                             | `AA8******`                                 | `200`                                | [Underpayment](./resources/EXAMPLES.MD#underpayment-details-scenario)                            |
| 'Multiple payments' success             | Success response with `200` status code where<br/>the user has multiple available payments                                                            | `AA9******`                                 | `200`                                | [Multiple payments](./resources/EXAMPLES.MD#multiple-payments-details-scenario)                  |
| Bad request error                       | Error response with `400` status code                                                                                                                 | `ER14001**`<br/>`ER14002**`                 | `400`                                | [Service error](#service-errors)                                                                 |
| Not Found error                         | Error response with `404` status code                                                                                                                 | `ER1403***`<br/>`ER1404***`<br/>`AA6******` | `404`                                | [Service error](#service-errors)                                                                 |
| Internal server error                   | Error response with `500` status code                                                                                                                 | `ER1500***`<br/>`ER1503***`                 | `500`                                | [Service error](#service-errors)                                                                 |
...
|-----------------------------------------|--------------------------------------------|------------------------------------------|--------------------------------------|----------------------------------------|
| Default success                         | Success response with `201` status code    | `AA*******`                              | `201`                                | TBC                                    |
| Bad request error                       | Error response with `400` status code      | `ER24001**`<br/>`ER24002**`              | `400`                                | TBC                                    |
| Forbidden error                         | Error response with `403` status code      | `ER2403***`                              | `403`                                | TBC                                    |
| Not Found error                         | Error response with `404` status code      | `ER2404***`                              | `404`                                | TBC                                    |
| Conflict error                          | Error response with `409` status code      | `ER2409***`                              | `409`                                | TBC                                    |
| Unprocessable Entity error              | Error response with `422` status code      | `ER2422***`                              | `422`                                | TBC                                    |
| Internal server error                   | Error response with `500` status code      | `ER2500***`                              | `500`                                | TBC                                    |
| Service unavailable error               | Error response with `503` status code      | `ER2503***`                              | `503`                                | TBC                                    |
